<template>
    <div class="linkBg">
        <div class="v1" id="drawArear">
            ...
            <LivePlayer :videoUrl="highPointUrl"  stretch :controls="false" style="width:100%;height:100vh;"/>
...
<!--                        <img :src="item.videoChooseUrl" alt="" class="imgVideo">-->
                    <LivePlayer :videoUrl="item.videoChooseUrl"  stretch :controls="false" class="imgVideo"/>
                ...
                <div class="iframeBox"  v-if="!item.liveShow">
                    ...
                    <iframe src="http://10.54.2.22/embedded.html" ref="iframe" :id="'iframeA'+item.id" width="100%"
                                height="100%"></iframe>
                    </div>
                </div>
            </div>
...
<!--                        <img :src="PTZurl" width="100%" height="100%">-->
                        <LivePlayer :videoUrl="PTZurl"  stretch :controls="false" class="imgVideo"/>
                    </div>
        ...
        watch: {
            ...
            linkRightShow(newVal,oldVal){
                ...
                if(newVal==false){
                    ...
                    this.PTZurl = 'http://' + this.$global.deviceUrl + '/live/media/' + this.PTZfile+'?format=mp4';
                }
            },
        },
        methods: {
            ...
            cameraChange(val) {
                ...
                var url = 'http://' + this.$global.deviceUrl + '/live/media/' + val.url+'?format=mp4';
            ...
            getDeviceData() {
                axios.get('/xpi/camera/list', {
                    ...
                    if (response.data) {
                        console.log(response.data.cameras, '设备')
            ...
            cameraHandle(val, index) {
                ...
                if(val.identification=='3'){
                    ...
                    this.PTZurl = ''
                    //对应球机的路径
                    this.PTZurl = 'http://' + this.$global.deviceUrl + '/live/media/' + val.videoFile+'?format=mp4';
                    console.log(this.PTZurl,'this.PTZurl')
                    this.highPointUrl = 'http://' + this.$global.deviceUrl + '/live/media/' + val.videoFile+'?format=mp4';;
                    console.log(this.highPointUrl,'this.highPointUrl');
                    this.highPointId = val.styleId;
                    this.getDeviceList();
                }else{
                    val.cameraPropVisible = true
                    val.videoChooseUrl = 'http://' + this.$global.deviceUrl + '/live/media/' + val.videoFile +'?format=mp4';
                }
            },
            /*摄像头关闭*/
            handleClose(val) {
