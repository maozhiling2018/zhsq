          ...
          <el-row class="conBox">
            <el-col :span="rowNumber"
              ...
              <div class="iframeBox" v-else>
                ...
                <iframe :src="'http://'+$global.deviceUrl+'/embedded.html'" ref="iframe" id="iframeMonitor" width="100%"
                        height="100%"></iframe>
              </div>
    ...
    nodeId(newVal,oldVal){
      if(newVal !==oldVal){
        ...
        if(this.spanIndex && this.spanIndex.length > 0){
          ...
          this.videoList[activeIndex].cameraUrl = 'http://' + this.$global.deviceUrl + '/live/media/' + videoPath;
